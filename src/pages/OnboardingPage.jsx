// First-launch welcome screen, mirroring the iOS OnboardingView: app name,
// Premium subtitle, Google sign-in (opens YouTube sign-in so the browser
// session carries Premium into the embedded player), or guest.
export default function OnboardingPage({ onComplete }) {
  return (
    <div className="flex min-h-screen flex-col bg-black px-7 pb-10">
      <div className="flex flex-1 flex-col items-center justify-center">
        <h1 className="font-p7 text-[52px] text-white">danae</h1>
        <p className="mt-3 font-p5 text-[15px] text-white/55">
          Premium users can enjoy ad-free playback
        </p>
      </div>
